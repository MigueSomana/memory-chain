...
const NavbarInit = ({ variant = "solid", className = "" }) => {
  ...
  const navClass = `mc-navbar mc-navbar--${variant} ${className}`;

  return (
    <nav className={`fluid-extended ${navClass}`}>
      <header>
        <div className="py-2">
          <div className="container-fluid">
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start mc-navbar__inner">
              <Link
                to="/home"
                className="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none"
              >
                <img src={logo} alt="MemoryChain" height="70" />
              </Link>
              ...
              <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                ...
                <li>
                  <Link to="/verify" className="nav-link text-white">
                    <svg
                      ...
                      aria-hidden="true"
                      fill="currentColor"
                      className="bi bi-shield-fill-check d-block mx-auto mb-1"
                      viewBox="0 0 16 16"
                    >
                ...
                <li>
                  {isLogged ? (
                    <Link to={profileHref} className="nav-link text-white">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
